...
| 关键词特征 | 内容策略 | 说明 |
|-----------|---------|------|
| 含 wps/金山/官网/会员/office 等品牌词，或价格/下载词 | **高关联(整篇WPS)** | 整篇围绕 WPS，WPS 是主角 |
| 教程/故障/模板/认知/场景词（非品牌导向） | **中关联(通用+WPS章节)** | 先讲通用方法，某章节带出 WPS |
| 纯通用方法论词（如何做周报/工作总结等） | **低关联(方法论轻带)** | 讲通用方法论，末尾轻提 WPS |

### 模板 A：高关联（整篇WPS）——品牌词/价格/下载词

```markdown
# 开头：3 句内抓人（给结论/数字/痛点），直接点明 WPS 是解决方案

## WPS 是什么 / 为什么选它
（一句话讲清 WPS 价值、适用人群）

## 具体怎么做（分步 + 配图）
（全程 WPS 操作路径，每步配 img/ 截图）
...
- **教程操作/格式转换/故障解决**：模板 B 通用主体 + WPS 章节；若为品牌词走模板 A
- **对比选择/价格购买**：模板 A（品牌词）或模板 C（方法论），客观对比、不贬低对手
- **功能认知/AI认知/品牌直达**：模板 A（整篇 WPS 讲功能/AI 能力）
- **模板获取**：模板 B（通用模板需求 + WPS 模板库章节）
